...
Definir un método reutilizable para posicionar un perfil profesional sintético
hacia roles de confiabilidad, plataforma, infraestructura y DevOps sin guardar
datos identificables de una persona candidata en el repositorio.

## Identidad profesional de referencia

- Usar únicamente el título, la función y el nivel que la persona candidata
  confirme para el caso activo.
- Separar la función formal, la función real y el rol objetivo cuando difieran.
...
- No afirmar responsabilidad productiva, SLO, MTTR, MTTD ni resultados
  financieros sin evidencia explícita.
