...
.board-header-meta { display: grid; justify-items: end; gap: .5rem; }
.board-reference-date { margin: 0; color: var(--muted); font-size: .8125rem; }
...
@media (forced-colors: active) {
  ...
  .recruiter-practice-document .skip-link:focus-visible { outline: 2px solid Highlight; outline-offset: 3px; }
