...
.board-sequence li, .board-proof-card, .board-risk-card, .board-rehearsal, .board-practice-gate, .board-day, .board-branch, .board-review { min-width: 0; padding: 1rem; background: var(--surface); border: 1px solid var(--line); }
