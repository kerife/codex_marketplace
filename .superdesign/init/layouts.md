...
Source: `plugins/professional-growth-coach/assets/private-first-interview-conversion-board-v2.html`
...
<body class="private-interview-board-document">
  <a class="skip-link" href="#main-content">{{SKIP}}</a>
  <main id="main-content" class="board-shell" tabindex="-1" aria-labelledby="board-heading">
    {{HEADER}}
    {{MAIN}}
  </main>
  {{FOOTER}}
