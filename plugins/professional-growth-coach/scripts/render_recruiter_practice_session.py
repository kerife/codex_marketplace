...
COPY = {
    "es": {
        ...
        "next_action_ready_missing_detail": "Lee la pregunta y prepara tu respuesta en tres movimientos: mínimo suministrado, detalle faltante y próxima confirmación. No se guarda tu respuesta.",
        "next_action_answer_missing_detail": "Responde con mínimo suministrado, detalle faltante y próxima confirmación. No se guarda tu respuesta.",
    ...
    "en": {
        ...
        "next_action_ready_missing_detail": "Read the question and prepare your answer in three moves: supplied minimum, missing detail, and next confirmation. Your answer is not saved.",
        "next_action_answer_missing_detail": "Answer with supplied minimum, missing detail, and next confirmation. Your answer is not saved.",
