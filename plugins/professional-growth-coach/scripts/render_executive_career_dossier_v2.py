...
COPY = {
    "es": {
        ...
        "market_next_safe_action": "Siguiente paso seguro: reunir una vacante fechada y verificable antes de reabrir la revisión.",
    ...
    "en": {
        ...
        "market_next_safe_action": "Safe next step: bring one dated, verifiable vacancy before reopening the review.",
