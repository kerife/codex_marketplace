...
class PrivateProseSafetyTests(unittest.TestCase):
    ...
    def test_safe_diagnostic_field_name_redacts_suspicious_names_only(self):
        cases = {
            ...
            "/var/log/synthetic-profile.json": "<redacted-field>",
            "/opt/synthetic-profile.json": "<redacted-field>",
            "/Applications/synthetic-profile.json": "<redacted-field>",
            "/Volumes/synthetic-profile.json": "<redacted-field>",
            "/root/synthetic-profile.json": "<redacted-field>",
            "/srv/synthetic-profile.json": "<redacted-field>",
            "/usr/local/synthetic-profile.json": "<redacted-field>",
            r"D:\work\synthetic-user\profile.json": "<redacted-field>",
            r"\\server\share\synthetic-user\profile.json": "<redacted-field>",
